...
| Aitos lava pit (`$18/$19=$04/$01`) | Not an action slot. Exact BG1 signature is `$DC`, one-to-six `$DD`, then `$DE`, over an equally wide `$DF` first fill row. Observed 64px rims begin at world `(1648,976)`, `(1888,992)`, and `(2144,976)`; the 128px rim begins at `(3616,928)`. Capture publishes the rim centre on BG1 within a 256px camera margin. |
