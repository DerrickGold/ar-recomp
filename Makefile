...
CLEAN_BUILD_DIRS := build build-next build-legacy build-release build-release-legacy build-control build-terrain build-asan build-trace $(PACKAGING)/build snesrecomp-go/build
