...
import (
	...
	"github.com/DerrickGold/snesrecomp-go/internal/fontprobe"
...
func Run(ctx context.Context, args []string, output io.Writer) error {
	...
	f.Usage = func() {
		fmt.Fprintf(output, "Usage: snesbuild language %s [options]\n", args[0])
