...
func opcodeDiff(args []string) error {
	...
	runtimeDir := flags.String("runtime-dir", "snesrecomp-go/runtime-next/src", "bundled runtime header directory")
...
func linkAudit(args []string) error {
	...
	runtimeDir := flags.String("runtime-dir", "snesrecomp-go/runtime-next/src", "bundled runtime source directory")
