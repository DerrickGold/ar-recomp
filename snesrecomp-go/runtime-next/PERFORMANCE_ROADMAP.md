...
1.6867 seconds for `runtime-next` and 1.7392 seconds for legacy, making the new
...
Against a preserved pre-change `runtime-next` binary, 12 warmed alternating
...
seconds and legacy at 1.7352 seconds, making `runtime-next` 11.00% faster on
...
of 1.74, 1.25, and 1.45 seconds, `runtime-next` is approximately 25%, 6%, and
