#ifndef SNESRECOMP_NEXT_RUNNER_GAME_MODULE_H
#define SNESRECOMP_NEXT_RUNNER_GAME_MODULE_H
...
#define RTL_GAME_MODULE_ABI_VERSION 1u
...
#define RTL_GAME_EXECUTION_API_V1_SIZE                                 \
    ((uint32_t)(offsetof(RtlGameExecutionApi, recover_dispatch_miss) +  \
                sizeof(((RtlGameExecutionApi *)0)->recover_dispatch_miss)))
 ...
 * existing APU/SPC/DSP safe points and may request bounded mutations. */
...
#define RTL_GAME_AUDIO_API_V1_SIZE                                     \
    ((uint32_t)(offsetof(RtlGameAudioApi, extension_upload) +           \
                sizeof(((RtlGameAudioApi *)0)->extension_upload)))
...
#define RTL_GAME_MODULE_V1_SIZE                                       \
