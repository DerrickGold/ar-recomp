...
#define SR_RUNNER_CAP_INPUT_DEVICES UINT64_C(0x0000000100000000)
#define SR_RUNNER_CAP_EXECUTION_CHECKPOINT UINT64_C(0x0000000200000000)
#define SR_RUNNER_CAP_POLL_WAIT UINT64_C(0x0000000400000000)
#define SR_RUNNER_CAP_PPU_BACKGROUND_VIEW UINT64_C(0x0000000800000000)
