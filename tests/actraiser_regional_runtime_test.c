...
int main(void) {
  ...
  assert(ActRaiserRegional_BeginActionRoom(3,0x300,&motion_time) && ActRaiserRegional_ActionMotionSnapshot()==0xfff);
  ...
  assert(ActRaiserRegional_ActionMotionSnapshot()==0xfff);
