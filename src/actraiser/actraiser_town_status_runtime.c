...
RecompReturn ActRaiser_RegionalTownStatusCycle(CpuState *cpu) { return Run(cpu,bank_03_82DB_M0X0); }
RecompReturn ActRaiser_RegionalTownStatusPlot(CpuState *cpu) { return Run(cpu,bank_03_91AE_M0X0); }
RecompReturn ActRaiser_RegionalTownStatusVisiblePlot(CpuState *cpu) { return Run(cpu,bank_03_91BC_M0X0); }
RecompReturn ActRaiser_RegionalTownStatusReport(CpuState *cpu) {
  return Run(cpu,cpu->m_flag?bank_03_BF8C_M1X0:bank_03_BF8C_M0X0);
}
