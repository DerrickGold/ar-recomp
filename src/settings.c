...
const SettingDesc g_setting_descs[] = {
  ...
  ACTION_SETTING("save_import", kSettingAction_SaveImport,
                 kSettingCat_Save, NULL, false, "Import save",
                      "Replace the active campaign from saves/imports/import.arsave, import.srm or import.ini, then restart. AR_SAVE_IMPORT and old import paths still work."),
  ACTION_SETTING("save_export_campaign", kSettingAction_SaveExportCampaign,
                 kSettingCat_Save, NULL, false, "Export campaign",
                      "Export saved progress, campaign settings and name to a new .arsave file in saves/exports. Unsaved gameplay is not included."),
  ACTION_SETTING("save_export_srm", kSettingAction_SaveExportSrm,
                 kSettingCat_Save, NULL, false, "Export raw SRAM",
                      "Export only cartridge data to a new .srm file in saves/exports. Use Export campaign to preserve campaign settings and enhanced name."),
  ACTION_SETTING("save_export_ini", kSettingAction_SaveExportIni,
                 kSettingCat_Save, NULL, false, "Export raw INI",
                      "Export only cartridge data to a new .ini file in saves/exports. Use Export campaign to preserve campaign settings and enhanced name."),
