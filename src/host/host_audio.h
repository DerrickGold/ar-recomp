 ...
 * remain fixed until HostAudio_Shutdown. False means the selected audio
 * contract could not be created; callers must stop the session rather than
 * continue with missing or desynchronised sound. */
