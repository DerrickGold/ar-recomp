...
static float SimTerrainGroundHeightWorld(
...
static float SimTerrainMaximumHeightWorld(
 ...
 * actor upward. */
static float SimObjectAltitudeBaseWorld(
...
static void DrawSimMapPlaneObject(const FrameSlot *slot,
                                  const SimRenderObject *object,
...
static bool DrawSimTownTerrain(
