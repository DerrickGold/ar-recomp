...
ArRegionalDifficultyChoice ArRegionalDifficulty_Choice(const ArRegionalDifficultyPolicy *policy) {
  ...
  if (!ArRegionalDifficulty_GroupSource(policy, &source)) return kArRegionalDifficultyChoice_Custom;
  if (source != kArRegionalSource_Europe) return policy->level == kArRegionalDifficulty_Normal
      ? kArRegionalDifficultyChoice_Original : kArRegionalDifficultyChoice_Custom;
  switch (policy->level) {
    case kArRegionalDifficulty_Beginner: return kArRegionalDifficultyChoice_Beginner;
    case kArRegionalDifficulty_Normal: return kArRegionalDifficultyChoice_Normal;
    case kArRegionalDifficulty_Expert: return kArRegionalDifficultyChoice_Expert;
...
bool ArRegionalDifficulty_Select(ArRegionalDifficultyChoice choice, ArRegionalDifficultyPolicy *out) {
  ...
  const ArRegionalDifficulty level = choice == kArRegionalDifficultyChoice_Beginner
      ...
      ? kArRegionalDifficulty_Expert : kArRegionalDifficulty_Normal;
  return ArRegionalDifficulty_Init(out, choice == kArRegionalDifficultyChoice_Original
      ? kArRegionalSource_US : kArRegionalSource_Europe, level);
}
