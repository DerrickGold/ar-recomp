...
typedef enum ArRenderBlendMode {
  ...
  /* Preserve destination RGB and add source alpha to destination alpha. This
   * accumulates weighted monochrome mask samples without brightening RGB. */
  kArRenderBlendMode_AlphaAccumulate,
