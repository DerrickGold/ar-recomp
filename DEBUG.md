...
8. **Document + commit**: a one-entry ledger append in §7 (root cause + fix + the reusable
   lesson), memory update if the lesson generalizes, then commit cfg/tool/doc changes together.
...
### Case study archive: the sim-mode bring-up arc (2026-07-01 → 07-04, RESOLVED)
