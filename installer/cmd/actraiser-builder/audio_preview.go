...
var actRaiserPreviewTracks = []audio.Track{
...
func selectAudioPreviewTracks(selection string) ([]audio.Track, error) {
	if selection == "" || selection == "all" {
		return append([]audio.Track(nil), actRaiserPreviewTracks...), nil
	}
...
func runAudioPreview(args []string) error {
	...
	paths, fingerprint, err := audio.RenderActRaiserPreviews(
