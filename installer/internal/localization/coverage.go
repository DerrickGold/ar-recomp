...
func (c *NativeCatalog) coverageReport(alignment *NativeRouteUnion) IRObject {
	...
	counts["consumer_reference_seed_sources"] = c.ReferenceResolution.UniqueSourceCount
	counts["unmapped_consumer_reference_seed_sources"] = c.ReferenceResolution.UnmappedUniqueSourceCount
